...
CREATE TABLE IF NOT EXISTS `Voitures`(
       ...
       description1 VARCHAR(264) NOT NULL,
...
insert into Voitures values(1,'FZ-208-DG', 1,'Xantia','Rouge',177500,1290,1361,65,2002,5,
                            ...
                            'Voiture de classe familiale et de gamme moyenne');
insert into Voitures values(2,'GF-056-VQ', 1,'Evasion','Gris',162000,2800,1525,80,2002,5,
                            ...
                            'Carrosserie: Monospace, Energie: Essence, Puissance fiscale: 9 CV, Puissance din: 120 ch, Boîte de vitesse: Manuel',
                            'Voiture spacieuse parfaite pour les voyages en famille');
insert into Voitures values(3,'GH-363-AC', 1,'C1','Blanc',19909,8990,865,35,2015,5,
                            ...
                            'Carrosserie: Citadine, Energie: Essence, Puissance fiscale: 4 CV, Puissance din: 72, Boîte de vitesse: Manuel',
                            'Voiture urbaine d''entrée de gamme');
insert into Voitures values(4,'KB-164-HJ', 2,'Caravelle S','Rouge',7549,17200,800,38,1968,2,
                            ...
                            'Carrosserie: Cabriolet, Energie: Essence, Puissance fiscale: 6 CV, Puissance din: 44 ch, Boîte de vitesse: Manuel',
                            'Cabriolet dérivé de la Dauphine qui rapellera les années 70');
insert into Voitures values(5,'KF-802-MT', 2,'Clio 3','Noire',87000,5495,1017,45,2015,5,
                            ...
                            'Carrosserie: Berline, Energie: Diesel, Puissance fiscale: 5 CV, Puissance din: 75 ch, Boîte de vitesse: Manuel',
                            'Citadine polyvalente et voiture la plus vendue en France en 2006, 2011 et 2012');
insert into Voitures values(6,'HR-764-ZN', 2,'Kangoo 2','Blanc',51600,15490,1320,60,2015,5,
                            ...
                            'Carrosserie: Monospace, Energie: Diesel, Puissance fiscale: 5 CV, Puissance din: 90 ch, Boîte de vitesse: Manuel',
                            'Voiture accentuée par son aspect pratique et sa rusticité, tant en version civile qu''en utilitaire');
insert into Voitures values(7,'HC-586-JX', 3,'806','Vert',117071,2499,1525,80,1999,5,
                            ...
                            'Carrosserie: Monospace, Energie: Diesel, Puissance fiscale: 9 CV, Puissance din: 120 ch, Boîte de vitesse: Manuel',
                            'Voiture destinée à la famille et aux grands voyages');
insert into Voitures values(8,'SN-119-KH', 3,'508','Noire',48633,9950,1425,72,2016,5,
                            ...
                            'Carrosserie: Berline, Energie: Diesel, Puissance fiscale: 6 CV, Puissance din: 120 ch, Boîte de vitesse: Automatique',
                            'Berline familiale routière haut de gamme');
insert into Voitures values(9,'TC-078-GQ', 3,'108','Argent',15,10600,860,35,2014,3,
                            ...
                            'Carrosserie: Compacte, Energie: Essence, Puissance fiscale: 4 CV, Puissance din: 72 ch, Boîte de vitesse: Manuel',
                            'Citadine avec un style qui se démarque par rapport à ses cousines Citroën C1, Peugeot 107 et Toyota Aygo');
insert into Voitures values(10,'S-670-HY', 4,'Veyron Grand Sport','Blanc',16254,959406,1968,100,2009,2,
                            ...
                            'Carrosserie: Coupé, Energie: Essence, Puissance fiscale: 119 CV, Puissance din: 1001 ch, Boîte de vitesse: Automatique',
                            'Voiture qui plaira à coup sûr aux amateurs de sport');
insert into Voitures values(11,'QE-794-LK', 2,'Twingo','Violet',47538,5700,943,35,2017,3,
                            ...
                            'Carrosserie: Citadine, Energie: Essence, Puissance fiscale: 5 CV, Puissance din: 69 ch, Boîte de vitesse: Manuel',
                            'Voiture urbaine qui propose un caractère jovial');
